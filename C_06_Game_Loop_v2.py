...
def initial_points(which_player):
    ...
    total = dice_1 + dice_2
    print(f"{which_player} - Roll 1: {dice_1}  \t| Roll 2: {dice_2} \t| Total: {total}")
...
# Play multiple round until a winner has been found
while comp_score < game_goal and user_score < game_goal:
    ...
    # if the user and computer roll equal points, the users is player 1...
        ...
        print("The initial rolls were the same, the user stars!")
